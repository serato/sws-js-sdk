...
describe('Rewards Tests', function () {
  ...
  describe('Rewards URI Validation Tests', function () {
    ...
    it(`confirms URI used in 'getReferalCampaigns()' method, by returning a non-404 HTTP response`,
      function () {
        console.log(swsClient.rewards.getReferalCampaigns)
    ...
    it(`confirms URI used in 'getReferalCampaign()' method with Campaign Id, by returning a non-404 HTTP response`,
      function () {
