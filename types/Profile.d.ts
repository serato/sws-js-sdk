export default class ProfileService extends Service {
    ...
    updateAvatar(): Promise<Avatar>;
    deleteAvatar(): Promise<Avatar>;
    getAllBetaPrograms(): Promise<BetaProgramList>;
    getBetaPrograms(): Promise<UserBetaProgramList>;
    addBetaProgram({ betaProgramId }: {
        betaProgramId: string;
    }): Promise<UserBetaProgram>;
    deleteBetaProgram({ betaProgramId }: {
        betaProgramId: boolean;
    }): Promise<any>;
    validateAllBetaPrograms(): Promise<UserBetaProgramList>;
    addSurvey({ survey }: {
        survey: any;
    }): Promise<any>;
    getPartnerPromotions(): Promise<PartnerPromotionCodeList>;
    partnerPromotionAddUser({ userId, promotionName }: {
        userId: string;
        promotionName: string;
    }): Promise<PartnerPromotionCode>;
}
export type Avatar = {
    ts: number;
    thumb: string;
