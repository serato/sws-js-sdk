export default class EcomService extends Service {
    ...
    getCatalogProducts(): Promise<CatalogProductList>;
    addPaymentMethod({ nonce, deviceData, billingAddressId }: {
        nonce: string;
        deviceData?: string;
        billingAddressId?: string;
    }): Promise<PaymentMethod>;
    paymentGatewayToken(): Promise<PaymentGatewayToken>;
    ...
    getInvoice(orderId: string, invoiceId: string, accept?: InvoiceMimeType): Promise<any>;
    ...
    getVouchers(): Promise<VoucherList>;
    ...
    getProductVoucherOrders(): Promise<ProductVoucherOrderList>;
}
